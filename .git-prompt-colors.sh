...
override_git_prompt_colors() {
  ...
  GIT_PROMPT_BRANCH="${BoldBlue}" # Magenta}"        # the git branch that is active in the current directory
  ...
  GIT_PROMPT_START_USER=" ${Yellow}${PathShort}${ResetColor}" #"_LAST_COMMAND_INDICATOR_ ${Yellow}${PathShort}${ResetColor}"
  GIT_PROMPT_START_ROOT=" ${GIT_PROMPT_START_USER}" #"_LAST_COMMAND_INDICATOR_ ${GIT_PROMPT_START_USER}"
